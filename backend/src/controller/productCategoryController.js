...
router.put("/:id", productCategoryRoute.getASingleProductCategoryById);

// used update single product category :
router.get("/:id", productCategoryRoute.updateSingleProductCategoryById);
